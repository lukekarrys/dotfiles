# Generated by Powerlevel10k configuration wizard on 2023-03-18 at 16:16 MST.
...
() {
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%k:%M:%S}'
  ...
  function instant_prompt_npm_version() {
    prompt_npm_version
  }

  typeset -g POWERLEVEL9K_NPM_VERSION_SHOW_ON_UPGLOB='package.json'
